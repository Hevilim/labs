...
image = pygame.image.load("pictures/clock.png")
image = pygame.transform.scale(image, (700, 600))

minute_img = pygame.image.load("pictures/rightarm.png")
minute_img = pygame.transform.scale(minute_img, (900, 740)) 
second_img = pygame.image.load("pictures/leftarm.png")
...
while not done: 
    ...
    minute_rect = rotated_minute.get_rect(center=(350, 300))
    second_rect = rotated_second.get_rect(center=(350, 300))
